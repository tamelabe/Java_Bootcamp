...
public class TransactionsService {
    ...
    void addTransaction(Integer senderID, Integer recipientID, Integer amount) {
        ...
        Transaction transactionCredit = new Transaction(sender, recipient, TransferCategory.CREDIT, amount);
        Transaction transactionDebit = new Transaction(transactionCredit);
        baseUsers.getById(senderID).addTransaction(transactionCredit);
        baseUsers.getById(recipientID).addTransaction(transactionDebit);
    }
